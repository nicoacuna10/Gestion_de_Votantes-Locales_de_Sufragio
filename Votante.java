...
public class Votante {
    ...
    public Votante(String nombreCompleto, String run, int edad, String comuna, String direccion, int estadoElectoral, int vocalDeMesa, String localAsignado, int numeroDeMesa) {
